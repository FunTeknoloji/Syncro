...
class NearbyAdapter(private val context: Context) : MeshAdapter {
    ...
    override fun startDiscovery() {
        ...
        connectionsClient.startDiscovery("com.example.quakesafe", object : EndpointDiscoveryCallback() {
        ...
        connectionsClient.startAdvertising("User", "com.example.quakesafe", connectionLifecycleCallback, advOptions)
    }
